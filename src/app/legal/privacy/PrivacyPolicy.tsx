export default function PrivacyPolicy() {
  return (
    <div className="mx-auto max-w-4xl bg-white px-6 py-12 leading-relaxed text-gray-800">
      ...
      <h3 className="mb-3 mt-6 text-xl font-medium text-gray-900">
        Interpretation
      </h3>
      <p className="mb-4">
      ...
      <ul className="list-disc space-y-4 pl-6">
        ...
        <li>
          <p>
            ...
            this Agreement) refers to idealite.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to idealite, accessible from{" "}
            <a
      ...
      <h4 className="mb-2 mt-5 text-lg font-medium text-gray-900">
        Personal Data
      </h4>
      <p className="mb-4">
      ...
      <ul className="mb-5 list-disc space-y-5 pl-6">
        <li>
          <p>
      ...
      <ul className="mb-5 list-disc space-y-4 pl-6">
        <li>
          <p>
      ...
      <ul className="mb-5 list-disc space-y-3 pl-6">
        <li>
      ...
      <ul className="mb-8 list-disc pl-6">
        <li>By email: john@idealite.xyz</li>
      </ul>
