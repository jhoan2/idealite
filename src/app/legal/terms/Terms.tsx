export default function Terms() {
  return (
    <div className="mx-auto max-w-4xl bg-white px-6 py-12 leading-relaxed text-gray-800">
      ...
      <div className="space-y-6">
        <p>
          From everyone at idealite, thank you for using our products! We build
        ...
        <p>
          When we say "Services", we mean our websites whether they are
          delivered within a web browser, desktop application, mobile
        ...
        <p>
          ...
          We do our best to deserve that trust by being open.
        </p>
      </div>

      <h2 className="mb-4 mt-10 border-b pb-2 text-2xl font-semibold text-gray-900">
        Account Terms
      </h2>
      ...
      <ol className="list-decimal space-y-3 pl-6">
        ...
        <li>
          ...
          want to export any data before your account is canceled, email me at
          john@idealite.xyz.
        </li>
        <li>
      ...
      <ol className="list-decimal space-y-3 pl-6">
        ...
        <li>
          ...
          trust to heart. You agree that idealite may process your data as
          ...
          <ul className="mt-2 list-disc space-y-2 pl-6">
            ...
            <li>
              <strong>To safeguard idealite.</strong> We'll look at logs and
            ...
            <li>
              ...
              idealite for assistance, our default stance is to refuse unless
              ...
              legal assistance treaty or agreement mechanism. If idealite is
        ...
        <li>
          ...
          subprocessors who handle personal data for idealite.
        </li>
        <li>
          Under the California Consumer Privacy Act ("CCPA"), idealite is a
          ...
          CCPA and not use idealite's Services in a way that violates the
          regulations.
        </li>
        <li>
          These Terms incorporate the EU General Data Protection Regulation
          ("GDPR") or United Kingdom General Data Protection Regulation ("UK
          GDPR") applies to your use of idealite Services to process Customer
          Data as defined in the DPA. The DPA linked above supersedes any
          previously agreed data processing addendum between you and idealite
          relating to your use of the idealite Services.
        </li>
      </ol>
      ...
      <ol className="list-decimal space-y-3 pl-6">
        ...
        <li>
          ...
          Company's logos or any Service logos for promotional purposes. We
      ...
      <p className="mb-4">
        ...
        Services (currently idealite). Any use of the API, including through a
        third-party product that accesses the Services, is bound by these Terms
      ...
      <div className="space-y-4">
        ...
        <p className="border-l-4 border-gray-400 bg-gray-100 p-4 italic">
          <strong>
      ...
      <div className="mt-12 border-t border-gray-200 pt-6 text-center text-sm text-gray-500">
        © 2025 idealite. All rights reserved.
      </div>
    </div>
  );
}
